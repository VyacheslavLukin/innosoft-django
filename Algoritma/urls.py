...
urlpatterns = [
    ...
    path('projects/', views.user_project_index, name="user_project_index"),
    path('projects/market/create/', views.create_market_project, name="create_market_project"),
    path('projects/create/', views.create_custom_project, name="create_custom_project"),
    path('projects/market/<prj_id>/', views.market_project_page, name="market_project_page"),
    path('projects/<prj_id>/', views.custom_project_page, name="custom_project_page"),
